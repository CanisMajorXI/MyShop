...
public class UserController {
    ...
    @RequestMapping("/register/request/code")
    @ResponseBody
    public String getCode(@RequestParam("email") String email,
        ...
        if (sendCodeToEmail(email, code)) {
            session.setAttribute("verificationCode", new Pair<String, Integer>(email, code));
            return "done";
        }
        return "error";
    }
    ...
    @RequestMapping("/register/add/user")
    @ResponseBody
